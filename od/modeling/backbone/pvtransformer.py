...
__all__ = ['pvt_tiny', 'pvt_small', 'pvt_small_f4']
...
class PyramidVisionTransformer(nn.Module):
    def __init__(self, enable_extra=False, img_size=224, patch_size=16, in_chans=3, num_classes=1000, embed_dims=[64, 128, 256, 512],
...
@registry.BACKBONES.register('pvtransformer_tiny')
def pvtransformer_tiny(cfg, pretrained=False, **kwargs):
    model = PyramidVisionTransformer(enable_extra=cfg.MODEL.BACKBONE.EXTRA,
...
@registry.BACKBONES.register('pvtransformer_small')
def pvtransformer_small(cfg, pretrained=False, **kwargs):
    model = PyramidVisionTransformer(enable_extra=cfg.MODEL.BACKBONE.EXTRA,
            patch_size=4, embed_dims=[64, 128, 320, 512], num_heads=[1, 2, 5, 8], mlp_ratios=[8, 8, 4, 4],
...
@registry.BACKBONES.register('pvtransformer_small_f4')
def pvtransformer_small_f4(cfg, pretrained=False, **kwargs):
    model = PyramidVisionTransformer(enable_extra=cfg.MODEL.BACKBONE.EXTRA,
            patch_size=4, embed_dims=[64, 128, 320, 512], num_heads=[1, 2, 5, 8], mlp_ratios=[8, 8, 4, 4],
            qkv_bias=True, norm_layer=partial(nn.LayerNorm, eps=1e-6), depths=[3, 4, 6, 3],
